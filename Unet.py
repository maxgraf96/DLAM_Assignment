...
class UNet(nn.Module):
    def __init__(self, image_size):
        ...
        self.conv_block1_64 = DownBlock(1, 64)
        self.conv_block64_128 = DownBlock(64, 128)
        self.conv_block128_256 = DownBlock(128, 256)
        self.conv_block256_512 = DownBlock(256, 512)
        self.conv_block512_1024 = DownBlock(512, 1024)
...
class DownBlock(nn.Module):
    def __init__(self, in_size, out_size, kernel_size=3, activation=F.tanh):
